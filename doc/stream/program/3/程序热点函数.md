...
stage2：与s1相比有更多的misstaken和l1-miss
...
stage3：与s2相比misstaken少，但是l1-miss多了很多
...
l2的miss出现在index0和index8，共计16次（每128个字出现一次，这里为什么不是32呢）
![1763966261559](image/程序热点函数/1763966261559.png)
这里仔细观察应该可以发现，是被蝶形因子在l2里挤出去的（同理stage3也是一样）
index1也是间歇性的抽风

顺序取数的output在这一阶段每16 iter会多取一次l1-line
原因：在这个stage，output每次会跨4个l1-line；而twiddle恰巧也是分布在1 5 9 13(每个line4个)，
这样总是会被某个twiddle占据的line影响
（而stage3是恰巧没有被影响的，因为那里的twiddle分别位于2 line）

和stage3相比，save的misstaken和l2-miss的增多抵消

stage5 1/16
l2方面主要是 新的twiddle + index 1 5 9 13的outpu
...
l2没少,减少了l1(twiddle复用 > 对output的复用有影响) 
